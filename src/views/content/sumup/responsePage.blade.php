            ...
            <div class="max-w-xl m-4 p-10 bg-white rounded shadow-xl">
                <div class="flex my-10 border-2 border-green-700 rounded-sm p-5 bg-green-50 justify-between items-center">
                    <div class="flex justify-start gap-5 items-center">
                        ...
                        <div>
                            <h1 class="font-bold tracking-wider text-gray-700">Status:</h1>
                            <span class="tracking-wider uppercase text-xs text-green-700 font-bold">{{ $paymentInfo['status'] ?? 'error' }}</span>
                        </div>
                    </div>
                </div>
                <div class="w-full">
